...
# Web 개발 패턴 -> MVC, MVT, .. 등등
#  - MVC(Model + View + Controller)

# 웹 브라우저(클라이언트) -> Request(https://naver.com/blog + 글작성)
# 네이버 웹 서버 -> Response(HTML, 정보 등을 웹 브라우저에게 전달)
#  1. Controller
#     -> 사용자의 Request 받기
...
# 2.WEB 개발 공부!
#  - 어느 분야로 작업을 정해도 웹개발을 기본적으로 알고있는게 도움
#  - Python + WEB + DB = 프로젝트(강추)
#  - Python Web -> Django, Flask, FastAPI
#  * 실제 회사 Python 웹개발 -> Django 
#  * FastAPI 추천
#   1) 웹개발(Spring-JAVA, Node-JS, Django-Python)취업순
...
# (*x200!!중요)SQL의 UPDATE문과 DELETE문은 반드시 WHERE 절과 함께 사용할 것! 
